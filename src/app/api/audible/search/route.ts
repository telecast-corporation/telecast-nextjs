...
function extractFromHTML(html: string, pattern: RegExp): string[] {
...
export async function GET(request: Request) {
  try {
    ...
    console.log(`✅ Found ${books.length} audiobooks for query: "${query}"`);
    ...
    console.error('❌ Audible scraping error:', {
